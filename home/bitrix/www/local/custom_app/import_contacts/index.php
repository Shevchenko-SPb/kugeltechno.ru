                ...
                <div id="columnDetails" style="display: none; margin-top: 15px;">
                    <div style="background-color: #f8f9fa; padding: 15px; border-radius: 4px; border-left: 3px solid #007bff;">
                        ...
                        <ul style="margin: 0; color: #495057;">
                            <li>Все столбцы должны присутствовать в файле в указанном порядке</li>
                            ...
                            <li>Например: "КонтактноеЛицо" = "ФИО" = "Контакт" = "Представитель" = "Полное имя"</li>
                            <li>Например: "Страна" = "Country" = "Государство" = "Регион"</li>
                        </ul>
                    </div>
                </div>
            </div>
